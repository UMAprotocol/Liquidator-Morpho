...
pub mod liquidator {
    ...
    impl<M: ::ethers::providers::Middleware> Liquidator<M> {
        ...
        pub fn liquidate_user(
            ...
            self.0
                .method_hash(
                    [77, 14, 199, 5],
                    (market_params, user, seized_assets, swap_params),
                )
    ...
    ///`SwapParams(uint256,uint256,address,bytes)`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
